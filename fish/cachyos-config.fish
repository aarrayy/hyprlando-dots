...
set -x PATH $PATH ~/.local/share/nvim/mason/bin
set -gx EDITOR code
set -gx TERM foot
set -gx BROWSER chromium-browser-unstable
set -gx XZ_OPT -T0
...
alias hdmi="xrandr --output HDMI-A-0 --mode 1280x720 --rate 60"
...
alias rg="ripgrep"
alias cpkrnl="git clone git@github.com:CachyOS/linux-cachyos.git"
alias resetlock="faillock --user array --reset"
alias cat="bat -pp"
alias stress="stress-ng --io-uring -1 -t 30 --no-rand-seed --affinity 1 --metrics-brief"
